 ...
 *
 *  @mixin
 *  @name module:lightrider/mixins~Proxyable
 ...
 *
 *  @see module:lightrider/mixins~Proxyable
 */
  ...
  constructor({ proxy, ...superOpts } = {}) {
    ...
    const proxyHandler = {
      ...
      set(target, propName, value) {
        ...
        if (!targetHasProp) {
          const proxyObjectHasMethod = isFunction(proxy[propName]);
